...
if [ "$1" = "debian11" ] || [ "$1" = "debian12" ]  || [ "$1" = "debian12tg10" ]  || [ "$1" = "debian13" ]  || [ "$1" = "debian13py" ] || [ "$1" = "ubuntu24.10" ] || [ "$1" = "ubuntu26.04py" ] || [ "$1" = "ubuntu26.04" ] || [ "$1" = "ubuntu24.04" ]; then
...
if  [ "$1" = "ubuntu24.04" ] || [ "$1" = "ubuntu24.10" ] || [ "$1" = "ubuntu26.04" ] || [ "$1" = "ubuntu26.04py" ] || [ "$1" = "debian13" ] || [ "$1" = "debian13py" ]; then
...
if  [ "$1" = "ubuntu24.04" ] || [ "$1" = "ubuntu24.10" ] || [ "$1" = "ubuntu26.04" ] || [ "$1" = "ubuntu26.04py" ]; then
...
if [ "$2" = "2" ]; then
    ...
    if [ "$1" = "debian10" ] || [ "$1" = "ubuntu24.04" ] || [ "$1" = "ubuntu24.10" ] || [ "$1" = "ubuntu26.04py" ] || [ "$1" = "ubuntu26.04" ] || [ "$1" = "ubuntu22.04" ] || [ "$1" = "ubuntu20.04" ] || [ "$1" = "ubuntu20.10" ] || [ "$1" = "debian11" ] || [ "$1" = "debian12tg10" ]  || [ "$1" = "debian12" ]  || [ "$1" = "debian13" ] || [ "$1" = "debian13py" ] ; then
...
if  [ "$1" = "debian13py" ] || [ "$1" = "ubuntu26.04py" ] ; then
